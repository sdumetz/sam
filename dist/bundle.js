...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ListView = __webpack_require__(158);
	...
	ReactDOM.render(_react2.default.createElement(_ListView2.default, null), document.getElementById('view'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AppView = __webpack_require__(159);
	
	var _AppView2 = _interopRequireDefault(_AppView);
	
	var _GotoView = __webpack_require__(162);
	  ...
	  _createClass(ListView, [{
	    ...
	    value: function handleClick(i) {
	      ...
	      if (apps[i] && apps[i]["Exec"]) {
	        return _XhrMixin2.default.postApp(apps[i]["Exec"]).catch(function (e) {
	    ...
	    key: 'handleCustom',
	    value: function handleCustom(url) {
	      return _XhrMixin2.default.postApp(url).catch(function (e) {
	        console.error(e.stack);
	      });
	    }
	  }, {
	    ...
	    value: function componentDidMount() {
	      ...
	      _XhrMixin2.default.getJSON("/list").then(function (res) {
	        _this2.setState({ apps: res });
	      }, function (e) {
	        console.error(e.stack);
	      });
	      window.onkeydown = function (evt) {
	        var apps = _this2._getApps();
	        evt = evt || window.event;
	        if (evt.keyCode == 13 && apps[_this2.state.select]) {
	          _this2.handleClick(_this2.state.select);
	        } else if (evt.keyCode == 37) {
	          _this2.setState({ select: _this2.state.select - 1 < 0 ? apps.length : _this2.state.select - 1 });
	        } else if (evt.keyCode == 39) {
	          _this2.setState({ select: _this2.state.select + 1 > apps.length ? 0 : _this2.state.select + 1 });
	        } else {
	    ...
	    key: '_getApps',
	    value: function _getApps() {
	      var _this3 = this;
	
	      return Object.keys(this.state.apps).filter(function (appname) {
	        return _typeof(_this3.state.apps[appname]["Desktop Entry"]) === "object" && typeof _this3.state.apps[appname]["Desktop Entry"]["Name"] === "string" ? true : false;
	      }).map(function (appname) {
	        return _this3.state.apps[appname]["Desktop Entry"];
	      });
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      var appviews = this._getApps().map(function (entry, index, apps) {
	        return _react2.default.createElement(_AppView2.default, { key: index, entry: entry, active: _this4.state.select == index, onClick: _this4.handleClick.bind(_this4, index) });
	      });
	      appviews.push(_react2.default.createElement(_GotoView2.default, { key: appviews.length, active: this.state.select == appviews.length, handleSend: this.handleCustom.bind(this) }));
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(
	          'div',
	          { style: divStyle, className: 'list' },
	          appviews
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AppIcon = __webpack_require__(160);
	
	var _AppIcon2 = _interopRequireDefault(_AppIcon);
	
	var _AppTitle = __webpack_require__(161);
	...
	var AppView = function (_React$Component) {
	  ...
	  function AppView(props) {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(AppView).call(this, props));
	  }
	  ...
	  _createClass(AppView, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { style: divStyle, className: 'appview', onClick: this.props.onClick },
	        _react2.default.createElement(_AppIcon2.default, { file: this.props.entry["Icon"], active: this.props.active }),
	        _react2.default.createElement(
	          _AppTitle2.default,
	          { title: this.props.entry["Name"], active: this.props.active },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AppIcon = function (_React$Component) {
	  ...
	  function AppIcon(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(AppIcon).call(this, props));
	
	    _this.state = { src: "/img/default_icon.png" };
	    return _this;
	  }
	  ...
	  _createClass(AppIcon, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement("div", { style: imgStyle, className: "icon" });
	    }
	  }]);
	...
	var AppView = function (_React$Component) {
	  ...
	  _createClass(AppView, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { style: divStyle, className: 'apptitle', onClick: this.handleClick },
	        _react2.default.createElement(
	          'h3',
	          null,
	          this.props.title
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GotoView = function (_React$Component) {
	  _inherits(GotoView, _React$Component);
	
	  function GotoView(props) {
	    _classCallCheck(this, GotoView);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(GotoView).call(this, props));
	  }
	  ...
	  _createClass(GotoView, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { style: divStyle, className: 'appview' },
	        _react2.default.createElement(_AppIcon2.default, { source: '/img/url.png', active: this.props.active }),
	        _react2.default.createElement(
	          _AppTitle2.default,
	          { title: 'Custom URL', active: this.props.active },
	          _react2.default.createElement(_CustomUrl2.default, { handleSend: this.props.handleSend, active: this.props.active })
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CustomUrl = function (_React$Component) {
	  _inherits(CustomUrl, _React$Component);
	
	  function CustomUrl(props) {
	    _classCallCheck(this, CustomUrl);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(CustomUrl).call(this, props));
	
	    _this.state = { url: "" };
	    return _this;
	  }
	
	  _createClass(CustomUrl, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'form',
	        { method: '', action: '', onSubmit: this.onSubmit.bind(this) },
	        _react2.default.createElement('input', { ref: 'input', placeholder: 'http://example.com', value: this.state.url, onChange: this.handleChange.bind(this), type: 'text' }),
	        _react2.default.createElement(
	          'button',
	          { type: 'submit' },
	          'Submit'
